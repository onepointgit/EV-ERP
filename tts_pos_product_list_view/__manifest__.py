...

{
    ...
    'website': "https://www.truetstechsolutions.com",
    "price": 15,
    "currency": 'EUR',
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            'tts_pos_product_list_view/static/src/css/pos.css',
            'tts_pos_product_list_view/static/src/js/pos_product_list_view.js',
            'tts_pos_product_list_view/static/src/xml/pos_product_list_view.xml',
        ],
    },
    ...
    "auto_install": False,
    "installable": True,
    'live_test_url': 'https://www.browseinfo.com/demo-request?app=tt_pos_product_list_view&version=18&edition=Community',
